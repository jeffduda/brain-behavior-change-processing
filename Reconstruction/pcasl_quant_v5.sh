...
Usage() {
	...
	echo " "
	echo "  notes:"
	echo "          maskfile = 0           means determine mask with 3dAutomask"
	echo "          BloodT1 = 0 or <empty> means use BloodT1 = $BloodT1 (msec)"
	echo "          BloodT1 = -1           means compute based on age and gender (requires XML file)"
	echo "          BloodT1 = #            means use provided # (msec)"
    exit 1
}
# --------------------------
